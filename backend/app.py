...
print(os.getenv("DATABASE_URL_UNPOOLED"))
# Configure session to store data in PostgreSQL
app.config['SESSION_TYPE'] = 'sqlalchemy'
app.config['SESSION_SQLALCHEMY'] = os.getenv("DATABASE_URL_UNPOOLED")  # Using the same DATABASE_URL for session storage
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv("DATABASE_URL_UNPOOLED")  # Set the database URI for SQLAlchemy
